...
/* Addon identity */
constexpr const char*    ADDON_NAME      = "ViP-WvW-Build-Coach";
constexpr const char*    ADDON_AUTHOR    = "Todd0042";
/* Unique uint32_t — a negative signed int cast to uint32_t (lessons learned §10) */
constexpr uint32_t       ADDON_SIGNATURE = (uint32_t)(-20250429);

/* Quick access / keybind identifiers */
constexpr const char* QA_IDENTIFIER = "QA_VIP_WVW_BUILD_COACH";
constexpr const char* KB_TOGGLE     = "KB_VIP_WVW_TOGGLE";
constexpr const char* ICON_NORMAL   = "ICON_VIP_WVW_BUILD_COACH";
constexpr const char* ICON_HOVER    = "ICON_VIP_WVW_BUILD_COACH_HOVER";
...
/* Selected reference build (user-defined) */
